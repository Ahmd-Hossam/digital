...
export class UserService {
  ...
  constructor(private router: Router) {
    ...
    this.token.centerId = this.load('centerId');
  }
  ...
  **/
  ...
  public getCenterId(): any {
    return this.token.centerId
  }
  ...
  public isUserAllowedTo(claim: string): any {
    let userClaims = (this.token && this.token.claims) || [];

    userClaims = userClaims.map((r: any) => r.name);
  ...
  public save(): boolean {
    ...
    this.persist('centerId', this.token.centerId, expires);
    return true;
  }
