(function ($) {
    ...
    // FAQ Accordion
    $(function () {
        $('.accordion').find('.accordion-title').unbind().on('click', function (e) {
            // Adds Active Class
            ...
            // $('.collapse-content').not($(this).next()).slideUp('fast');
            // $('.collapse-content').not($(this).next()).slideUp('show');
            // $('.collapse-content').not($(this).next()).removeClass('show');
