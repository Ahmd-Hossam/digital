...
function NgxSelectComponent_div_4_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function NgxSelectComponent_div_4_span_1_Template_span_click_1_listener($event) { return $event.stopPropagation(); });
    ɵngcc0.ɵɵelementContainer(2, 20);
    ɵngcc0.ɵɵelementStart(3, "a", 26);
    ɵngcc0.ɵɵlistener("click", function NgxSelectComponent_div_4_span_1_Template_a_click_3_listener($event) { ɵngcc0.ɵɵrestoreView(_r21); const option_r17 = ctx.$implicit; const ctx_r20 = ɵngcc0.ɵɵnextContext(2); return ctx_r20.optionRemove(option_r17, $event); });
...
function NgxSelectComponent_input_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngClass", ctx_r3.setFormControlSize())("tabindex", ctx_r3.multiple === false ? -1 : 0)("disabled", ctx_r3.disabled)("placeholder", ctx_r3.optionsSelected.length ? "" : ctx_r3.placeholder)("autocomplete", ctx_r3.autocomplete);
} }
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgxSelectOptionDirective, [{
        type: Directive,
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgxSelectOptionSelectedDirective, [{
        type: Directive,
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgxSelectOptionNotFoundDirective, [{
        type: Directive,
...
NgxSelectComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: NgxSelectComponent, selectors: [["ngx-select"]], contentQueries: function NgxSelectComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, NgxSelectOptionDirective, 3, TemplateRef);
        ɵngcc0.ɵɵcontentQuery(dirIndex, NgxSelectOptionSelectedDirective, 3, TemplateRef);
        ɵngcc0.ɵɵcontentQuery(dirIndex, NgxSelectOptionNotFoundDirective, 3, TemplateRef);
    } if (rf & 2) {
        let _t;
        ...
        ɵngcc0.ɵɵproperty("tabindex", ctx.disabled ? -1 : 0)("ngClass", ctx.setFormControlSize(ɵngcc0.ɵɵpureFunction2(7, _c10, ctx.multiple === true, ctx.optionsOpened && ctx.optionsFiltered.length), ctx.multiple === true));
        ɵngcc0.ɵɵadvance(2);
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgxSelectComponent, [{
        type: Component,
        args: [{
                selector: 'ngx-select',
...
NgxSelectModule.ɵfac = function NgxSelectModule_Factory(t) { return new (t || NgxSelectModule)(); };
NgxSelectModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: NgxSelectModule });
NgxSelectModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ imports: [[
            CommonModule,
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgxSelectModule, { declarations: function () { return [NgxSelectComponent, NgxSelectOptionDirective, NgxSelectOptionSelectedDirective, NgxSelectOptionNotFoundDirective]; }, imports: function () { return [CommonModule]; }, exports: function () { return [NgxSelectComponent, NgxSelectOptionDirective, NgxSelectOptionSelectedDirective, NgxSelectOptionNotFoundDirective]; } }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgxSelectModule, [{
        type: NgModule,
        args: [{
                imports: [
                    CommonModule,
