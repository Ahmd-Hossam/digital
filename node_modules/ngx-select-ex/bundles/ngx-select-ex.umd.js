...
}(this, (function (exports, core, common, forms, platformBrowser, rxjs, operators, isEqual, escapeStringRegexp) { 'use strict';
    ...
    ***************************************************************************** */
        ...
        NgxSelectOption.prototype.renderText = function (sanitizer, highlightText) {
            if (this.cacheHighlightText !== highlightText || this.cacheRenderedText === null) {
                ...
                if (this.cacheHighlightText) {
                    this.cacheRenderedText = sanitizer.bypassSecurityTrustHtml((this.text + '').replace(new RegExp(escapeStringRegexp__default['default'](this.cacheHighlightText), 'gi'), '<strong>$&</strong>'));
                }
                else {
    ...
    var NgxSelectComponent = /** @class */ (function () {
        ...
        NgxSelectComponent.prototype.filterOptions = function (search, options, selectedOptions) {
            var _this = this;
            var regExp = new RegExp(escapeStringRegexp__default['default'](search), 'i');
