...
function CodeInputComponent_span_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function CodeInputComponent_span_0_Template_input_click_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r5); const ctx_r4 = ɵngcc0.ɵɵnextContext(); return ctx_r4.onClick($event); })("paste", function CodeInputComponent_span_0_Template_input_paste_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r5); const i_r2 = ctx.index; const ctx_r6 = ɵngcc0.ɵɵnextContext(); return ctx_r6.onPaste($event, i_r2); })("input", function CodeInputComponent_span_0_Template_input_input_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r5); const i_r2 = ctx.index; const ctx_r7 = ɵngcc0.ɵɵnextContext(); return ctx_r7.onInput($event, i_r2); })("keydown", function CodeInputComponent_span_0_Template_input_keydown_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r5); const i_r2 = ctx.index; const ctx_r8 = ɵngcc0.ɵɵnextContext(); return ctx_r8.onKeydown($event, i_r2); });
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
CodeInputComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: CodeInputComponent, selectors: [["code-input"]], viewQuery: function CodeInputComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵtemplate(0, CodeInputComponent_span_0_Template, 3, 4, "span", 0);
    } if (rf & 2) {
...
CodeInputModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: CodeInputModule });
CodeInputModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ imports: [[
            CommonModule
        ]] });
