...
function NgxTypeAheadComponent_ng_template_0_section_0_button_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function NgxTypeAheadComponent_ng_template_0_section_0_button_2_Template_button_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r10); const result_r4 = ctx.$implicit; const i_r5 = ctx.index; const ctx_r9 = ɵngcc0.ɵɵnextContext(3); return ctx_r9.handleSelectionClick(result_r4, i_r5); });
...
NgxTypeAheadComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: NgxTypeAheadComponent, selectors: [["ngx-typeahead"], ["", "ngxTypeahead", ""]], viewQuery: function NgxTypeAheadComponent_Query(rf, ctx) { if (rf & 1) {
...
NgxTypeaheadModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: NgxTypeaheadModule });
NgxTypeaheadModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ imports: [[CommonModule, HttpClientModule, HttpClientJsonpModule], CommonModule] });
